...
# Usage
  ...
  * If you want to launch it with the 3d obstacle avoidance, provide the additional argument `with_camera:=true`. Make sure that you have a depth camera publishing on the topic `head_xtion`, for more details see https://github.com/strands-project/scitos_common.
